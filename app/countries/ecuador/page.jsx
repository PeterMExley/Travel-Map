...
export default function EcuadorPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Ecuador</h1>

      <img
        src="/photos/south-america/ecuador/11.jpeg"
        alt="Ecuador"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/south-america/ecuador/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/south-america/ecuador/${image}`}
              alt={image}
