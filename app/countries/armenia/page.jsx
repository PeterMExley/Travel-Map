...
export default function ArmeniaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Armenia</h1>

      <img
        src="/photos/asia/armenia/9.jpeg"
        alt="Armenia"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/asia/armenia/${image}`} target="_blank">
            <img
              src={`/photos/asia/armenia/${image}`}
              alt={image}
