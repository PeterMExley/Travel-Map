...
export default function MaltaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Malta</h1>

      <img
        src="/photos/europe/malta/3.jpeg"
        alt="Malta"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/europe/malta/${image}`} target="_blank">
            <img
              src={`/photos/europe/malta/${image}`}
              alt={image}
