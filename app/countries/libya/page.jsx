...
export default function LibyaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Libya</h1>

      <img
        src="/photos/africa/libya/12.jpeg"
        alt="Libya"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/africa/libya/${image}`} target="_blank">
            <img
              src={`/photos/africa/libya/${image}`}
              alt={image}
