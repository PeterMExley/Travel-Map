...
export default function RigaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Riga</h1>

      <img
        src="/photos/europe/riga/10.jpeg"
        alt="Riga"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/europe/riga/${image}`} target="_blank">
            <img
              src={`/photos/europe/riga/${image}`}
              alt={image}
