...
export default function DubrovnikPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Dubrovnik</h1>

      <img
        src="/photos/europe/dubrovnik/1.jpeg"
        alt="Dubrovnik"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/europe/dubrovnik/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/europe/dubrovnik/${image}`}
              alt={image}
