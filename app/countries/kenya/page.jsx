...
export default function KenyaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Kenya</h1>

      <img
        src="/photos/africa/kenya/1.jpeg"
        alt="Kenya"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/africa/kenya/${image}`} target="_blank">
            <img
              src={`/photos/africa/kenya/${image}`}
              alt={image}
