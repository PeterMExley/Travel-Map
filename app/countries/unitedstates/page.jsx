...
export default function UnitedStatesPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">United States</h1>

      <img
        src="/photos/north-america/united states/7.jpeg"
        alt="United States"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/north-america/united states/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/north-america/united states/${image}`}
              alt={image}
