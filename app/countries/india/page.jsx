...
export default function IndiaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">India</h1>

      <img
        src="/photos/asia/india/21.jpeg"
        alt="India"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/asia/india/${image}`} target="_blank">
            <img
              src={`/photos/asia/india/${image}`}
              alt={image}
