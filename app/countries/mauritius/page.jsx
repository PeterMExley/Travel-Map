...
export default function MauritiusPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Mauritius</h1>

      <img
        src="/photos/africa/mauritius/9.jpeg"
        alt="Mauritius"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/africa/mauritius/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/africa/mauritius/${image}`}
              alt={image}
