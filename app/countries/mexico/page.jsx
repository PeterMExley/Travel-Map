...
export default function MexicoPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Mexico</h1>

      <img
        src="/photos/north-america/mexico/11.jpeg"
        alt="Mexico"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/north-america/mexico/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/north-america/mexico/${image}`}
              alt={image}
