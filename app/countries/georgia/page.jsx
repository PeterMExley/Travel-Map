...
export default function GeorgiaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Georgia</h1>

      <img
        src="/photos/asia/georgia/7.jpeg"
        alt="Georgia"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/asia/georgia/${image}`} target="_blank">
            <img
              src={`/photos/asia/georgia/${image}`}
              alt={image}
