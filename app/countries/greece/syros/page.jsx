...
export default function SyrosPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Syros</h1>

      <img
        src="/photos/europe/greece/syros/1.jpeg"
        alt="Syros"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/europe/greece/syros/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/europe/greece/syros/${image}`}
              alt={image}
