...
export default function MilosPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Milos</h1>

      <img
        src="/photos/europe/greece/milos/7.jpeg"
        alt="Milos"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/europe/greece/milos/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/europe/greece/milos/${image}`}
              alt={image}
