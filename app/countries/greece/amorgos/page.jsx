...
export default function AmorgosPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Amorgos</h1>

      <img
        src="/photos/europe/greece/amorgos/4.jpeg"
        alt="Amorgos"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/europe/greece/amorgos/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/europe/greece/amorgos/${image}`}
              alt={image}
