...
export default function SantoriniPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Santorini</h1>

      <img
        src="/photos/europe/greece/santorini/3.jpeg"
        alt="Santorini"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/europe/greece/santorini/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/europe/greece/santorini/${image}`}
              alt={image}
