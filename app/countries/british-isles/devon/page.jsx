...
export default function DevonPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Devon</h1>

      <img
        src="/photos/british-isles/devon/2.jpeg"
        alt="Devon"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/british-isles/devon/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/british-isles/devon/${image}`}
              alt={image}
