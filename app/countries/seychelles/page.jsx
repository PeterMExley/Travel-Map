...
export default function SeychellesPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Seychelles</h1>

      <img
        src="/photos/africa/seychelles/19.jpeg"
        alt="Seychelles"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/africa/seychelles/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/africa/seychelles/${image}`}
              alt={image}
