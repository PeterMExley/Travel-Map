...
export default function ElSalvadorPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">El Salvador</h1>

      <img
        src="/photos/north-america/elsalvador/8.jpeg"
        alt="El Salvador"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/north-america/elsalvador/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/north-america/elsalvador/${image}`}
              alt={image}
