...
export default function KomodoPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Komodo</h1>

      <img
        src="/photos/asia/komodo/6.jpeg"
        alt="Komodo"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a key={image} href={`/photos/asia/komodo/${image}`} target="_blank">
            <img
              src={`/photos/asia/komodo/${image}`}
              alt={image}
