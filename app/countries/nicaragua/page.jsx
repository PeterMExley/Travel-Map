...
export default function NicaraguaPage() {
  return (
    <div className="bg-slate-950 min-h-screen text-white p-8">
      <h1 className="text-5xl font-bold mb-8">Nicaragua</h1>

      <img
        src="/photos/north-america/nicaragua/9.jpeg"
        alt="Nicaragua"
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {IMAGES.map((image) => (
          <a
            key={image}
            href={`/photos/north-america/nicaragua/${image}`}
            target="_blank"
          >
            <img
              src={`/photos/north-america/nicaragua/${image}`}
              alt={image}
